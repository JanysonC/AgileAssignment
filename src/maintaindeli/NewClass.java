...
//              dIC = sc.next();
                ...
                if (!validateIC(dIC)) {  
                  System.out.println("Invalid of IC number please insert again,Thank You!\n");                     
                }                   
            ...
            do{
                ...
                if(validate(dEmail)){
                    ...
                    System.out.println("Invalid of E-mail enter. Please enter correct email. Thank You!");
                }
            ...
            for(int i=0; i<addDeli.size(); i++){            
             System.out.println(String.format("%8s     %13s     %6s       %13s     %22s      %8s",addDeli.get(i).getDeliName()
     ...
     public static boolean isAlpha(String aString){
         ...
         for(int i=0;i<aString.length();i++){
              for(int j=0;j<alphabet.length();j++){
                ...
                if(charCount != (i+1)){
//                     System.out.println("Invalid input of the name! Please enter again, Thank You!");
                     return false;
                }
        }
          return true;
